...
### Test
- v1.26.0 auto self-update test release'i — icerik degisikligi yok, sadece versiyon bump
...
### Test
- v1.25.4 self-update test release'i — icerik degisikligi yok, sadece versiyon bump
...
### Test
- v1.23.8 self-update testi icin versiyon bump
